...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{asset('template')}}/dist/img/kementrian.png" alt="AdminLTELogo"
                height="60" width="60">
        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" a href="{{ route('logout') }}"
                            ...
                            {{ __('Log Out') }}</a>
                        <form class="d-inline mt-1 ml-200" id="logout-form" action="{{ route('logout') }}" method="POST"
                            class="nav-link">
                            @csrf
                        </form>
                    </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{asset('template')}}/dist/img/kementrian.png" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="page-hero bg-image overlay-dark"
                        style="background-image: url('{{asset('template')}}/dist/img/tabelkeluar.jpg'); height: 180px; width:100%;">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="btn-group">
                                            <?php
                      if(!empty($surat->seksi) || $surat->arsip == 'Diarsipkan'){
                        ?> <a href="data-surat/{{ $surat->id }}/verifikasi" id="verif"
                                                class="btn btn-success disabled">Verifikasi</a><?php
                      }else if(!empty($surat->seksi) && $surat->arsip == 'Tidak Diarsipkan'){
                        ?> <a href="data-surat/{{ $surat->id }}/verifikasi" id="verif"
                                                class="btn btn-success disabled">Verifikasi</a><?php
                      }else{
                        ?> <a href="data-surat/{{ $surat->id }}/verifikasi" id="verif"
                                                class="btn btn-success">Verifikasi</a><?php
                      }
                    ?>
                                            <a href="data-surat/{{ $surat->id }}/edit"
                                                class="btn btn-primary d-inline ml-3">Edit</a>
                                            <form class="d-inline ml-3" action="data_surat/{{ $surat->id }}/delete"
                                                method="POST">
                                                @csrf
                                                @method("delete")
