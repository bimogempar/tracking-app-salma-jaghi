            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="page-hero bg-image overlay-dark"
                        style="background-image: url('{{asset('template')}}/dist/img/DASHBOARD.jpg'); height: 180px; width:100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                      if(($surat->bukti ==null)){
                          ?> <img class="popup" src="/storage/{{ $surat->bukti }}" style="width: 120px; display:none;">
                                        </td><?php
                        }else{
                          ?> <img class="popup" src="/storage/{{ $surat->bukti }}" style="width: 120px;"></td><?php
                        }
                      ?>
                                        </td>
                                        <td>
                                            <a href="/storage/{{ $surat->file }}"
