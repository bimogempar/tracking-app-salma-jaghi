              ...
              {{csrf_field()}}
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_agenda" value="{{ old('no_agenda') ?? $data_surat->no_agenda }}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">No Surat</label>
                    <input type="text" class="form-control" name="no_surat" value="{{ old('no_surat') ?? $data_surat->no_surat }}">
                  </div>
                  <div class="form-group">
